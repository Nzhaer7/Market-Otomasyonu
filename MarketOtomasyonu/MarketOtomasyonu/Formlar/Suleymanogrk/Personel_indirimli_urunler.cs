...
{
    public partial class Personel_indirimli_urunler : Form
    {
        public Personel_indirimli_urunler()
        {
            InitializeComponent();
        }

        private void Personel_indirimli_urunler_Load(object sender, EventArgs e)
        {
