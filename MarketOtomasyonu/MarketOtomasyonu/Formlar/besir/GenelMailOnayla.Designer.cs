namespace MarketOtomasyonu.Formlar.besir
{
	partial class GenelMailOnayla
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Mailinize Gönderilen Kodu Giriniz";
			// 
			// textBox1
			// 
			...
			this.Name = "GenelMailOnayla";
			this.Text = "GenelMailOnayla";
			this.Load += new System.EventHandler(this.GenelMailOnayla_Load);
